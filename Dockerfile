...
# Add NGROK token directly
ENV NGROK_TOKEN=2bmDkAveY0grVVDlgwVXiOP5ia2_3vyBFrEpUdZou7veySL6p
...
# Start SSH service (even though it's better to run it in CMD/ENTRYPOINT)
